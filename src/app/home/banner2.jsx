...
const LargeSvg = ({ className, width, height, preserveAspectRatio, onLoad, ...props }) => {
  ...
  useEffect(() => {
    const fetchSvg = async () => {
      try {
        const response = await fetch('https://res.cloudinary.com/doubxarxb/image/upload/v1756711612/lrge_an38fl.svg');
